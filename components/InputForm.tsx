    ...
    return(
        <div className = "h-full p-4 grid grid-cols-2">
            ...
            <div className = ""> 
                <div className = "">
                    <form className = "flex flex-col border p-2">
                        ...
                        <input spellCheck="false" className = "border p-2" placeholder="Start Here..." onChange = {e => props.setTitle(e.target.value)} defaultValue = {props.title ? props.title : ""}></input>
                        ...
                        <textarea spellCheck="false" placeholder="Start Here..." className = "border h-96 p-2" onChange = {e => props.setContent(e.target.value)} defaultValue = {props.content ? props.content : ""}></textarea>
                    </form>
            ...
            <div className = "ml-4 h-2/3 flex-none"> 
                ...
                <div className = "h-full p-2 border overflow-scroll unreset" dangerouslySetInnerHTML = {createCleanMarkdown(props.content)}></div>
            </div> 
            </>
            }
        </div>
