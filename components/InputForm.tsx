      ...
      {user && (
        <>
          <form className="flex flex-col border p-2">
            ...
            ></input>
            <label htmlFor="textarea" className="font-bold text-gray-700">
              Card Description:
            </label>
            <textarea
              spellCheck="false"
            ...
            ></textarea>
            <label htmlFor="textarea" className="font-bold text-gray-700 mt-4">
          ...
          {!props.edit && (
            <>
              {props.loading && (
                <div className="my-2 p-2 border-2 text-white bg-indigo-500 rounded-xl font-bold flex justify-center">
