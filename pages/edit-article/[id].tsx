...
const EditArticle: React.FC<{article: Article}> = (props) => {
     ...
     return(
         <InputForm title = {title} description = {description} content = {content} resubmitHandler = {resubmitHandler} deleteHandler = {deleteHandler} setTitle = {setTitle} setDescription = {setDescription} setContent = {setContent}></InputForm>  
     )
    }
